...
export default function Hero() {
  ...
  const desktopFallbackImage = 'https://i.pinimg.com/1200x/0e/30/2b/0e302b3b391897605d1421dd01e68aad.jpg';
  const mobileFallbackImage = 'https://i.pinimg.com/1200x/0f/fa/0f/0ffa0fb9c06bf05a81ce3c80128782a4.jpg';
  ...
  useEffect(() => {
    ...
    video.src = isMobile ? '/jackson.mp4' : '/jackson3.mp4';
    ...
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      {videoLoaded && !videoError && (
        <>
          ...
          >
            <source src={isMobile ? "/jackson.mp4" : "/jackson2.mp4"} type="video/mp4" />
